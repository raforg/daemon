...
#ifndef LIBPROG_ERR_H
#define LIBPROG_ERR_H
...
void debug __PROTO ((size_t level, const char *fmt, ...));
void vdebug __PROTO ((size_t level, const char *fmt, va_list args));
...
void debugsys __PROTO ((size_t level, const char *fmt, ...));
void vdebugsys __PROTO ((size_t level, const char *fmt, va_list args));
