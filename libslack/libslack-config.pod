...
L<http://www.libslack.org/|http://www.libslack.org/>. It can also download
the latest version. It can also upgrade libslack. It can also uninstall
libslack.
...
L<http://libslack.org/|http://libslack.org/>. This downloads the latest
